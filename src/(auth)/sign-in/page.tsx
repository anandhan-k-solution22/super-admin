...
export default function LoginForm({ initialEmail = "" }: LoginFormProps) {
  ...
  const { signIn, admin, loading, setForgotPasswordEmail } = useAdminAuthStore();
  ...
  // Keep user on login page even after authentication
  // The LoginForm will be shown as the initial page after login
